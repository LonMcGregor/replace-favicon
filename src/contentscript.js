...
function infectFavicon(baseUri) {
  ...
  hash = hex_md5(baseUri)

  // create favicon link to gravatar
  var linkElement = document.createElement("link");
  linkElement.id =  'replaceMissingFavicon';
  linkElement.rel = 'icon';
  linkElement.href = 'http://www.gravatar.com/avatar/' + hash + '?s=16&d=identicon';
...
function provideFavicon(){
  ...
  console.log(document.querySelectorAll("link[rel~='icon']").length);
  if (document.querySelectorAll("link[rel~='icon']").length > 0) {
    return;
  }

  infectFavicon(window.location.href);
